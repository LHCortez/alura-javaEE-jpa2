...
import br.com.luizcortez.model.Categoria;
import br.com.luizcortez.model.Loja;
import br.com.luizcortez.model.Produto;
	...
	public void init() {
		...
		template.execute(new TransactionCallbackWithoutResult() {
			...
			protected void doInTransactionWithoutResult(TransactionStatus status) {
				...
				violao.setLinkDaFoto("https://a-static.mlcdn.com.br/618x463/violao-classico-acustico-csr-851-39-6-cordas/vendas-rapidas/8081/8621326f4e1a675849be273eaed0da7c.jpg");
